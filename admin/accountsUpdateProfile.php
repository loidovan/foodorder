...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    $update_check = $class->update_profile_account($_POST, $adminId);
}
?>
                            ...
                            <div class="row ml-5 mr-5 mt-5">
                                ...
                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= $row['adminName'] ?>" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Nhập tên người dùng" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleFormControlInput2">Email</label>
                                            <input type="email" value="<?= $row['adminEmail'] ?>" name="email" class="form-control" id="exampleFormControlInput2" placeholder="Nhập email" required>
                                        </div>
